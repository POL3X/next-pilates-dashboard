...
export function UserAttributeItem({ userUserAttribute, companyUuid, setRefresh}: Props) {
    ...
    const handleEditSave = async () => {
        if(isEditing){
            await editUserUserAttributeAction(userUserAttribute.userUuid, userUserAttribute.userAttributeUuid, inputValue, companyUuid)
    ...
    const deleteUserUserAttribute = async () => {
        await deleteUserUserAttributeAction(userUserAttribute.userUuid, userUserAttribute.userAttributeUuid, companyUuid)
        setRefresh(Math.random)
    }
